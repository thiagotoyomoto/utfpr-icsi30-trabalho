...
from algorithms.search.offline.bfs import bfs
from algorithms.search.offline.a_star import aStar
...
class Rescuer(AbstAgent):
    ...
    def planner(self):
        ...
        offline_search_algorithm = aStar(self.map, self.COST_LINE, self.COST_DIAG)
        ...
        for vic_id in sequence:
            ...
            plan, time = offline_search_algorithm.search(start, goal, self.plan_rtime)
